(() => {
  ...
  const translations = new Map([
    ...
    ["Mesoscale Function - Runwen Yao", "中尺度功能 - 姚润文"],
    ...
    ["Theme I: Mesoscale regulation", "主题 I：中尺度调控"],
    ...
    ["My early work asked a simple question: can RNA actively sh -roscopy with molecular and cell biology approaches to directly visualize how RNA organizes nuclear architecture.", "我早期的研究围绕一个核心科学问题展开：RNA 是否能够主动塑造细胞核结构？为解答这一问题，我整合显微成像、分子生物学与细胞生物学手段，原位解析 RNA 调控细胞核内空间结构的组织机制。"],
    ...
    ["These findings suggests a principle: condensates are structured systems that actively direct molecular flow, rather than passive containers.", "这些发现凝练出核心研究准则：生物分子凝聚体并非容纳生化反应的被动容器，而是可主动引导分子流动、精准调控生化进程的结构化动态系统。"],
  ...
  const attributeTranslations = new Map([
    ...
    ["Open mesoscale function research page", "打开中尺度功能研究页面"],
    ...
    ["Placeholder figure for mesoscale condensate organization", "中尺度凝聚体组织示意图"],
